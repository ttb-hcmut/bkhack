...
At various "scales" of perspective, the system can be split into layers.

For the front-end, there is a separation where the Reason code + HTML implements the "functional" layout, and the CSS implements the style (see Style layering).
...
> [!NOTE]
> This is implemented _entirely_ in CSS.
