...
> [!NOTE]
> Elsewhere this culture will be discouraged due to maintenance complexity, however our team is small (~4 people) and doesn't grow and we keep a close social social, so for us it's fine.
...
> [!NOTE]
> Also, we don't prevent anyone from modifying each other's code, but it is discouraged.
