...
#lorem(30) We introduced *`fiber`* as a library that implements _structured concurrency_--a concurrency algebra for internal #o.bkhack modules. It is an extension of JavaScript Promise equipped with _control capabilities_ i.e. to cancel and perform group actions.\
