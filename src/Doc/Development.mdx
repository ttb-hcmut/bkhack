...
nix-shell
```
If you do not need Tinymist (for example, when not working on the documentation), you can use a lighter shell configuration:
```sh
nix-shell --arg withTinymist false
```
---
